...
2. [**ES6 Modules (современный стандарт)**](#2-es6-modules-современный-стандарт)
3. [**Практические примеры**](#3-практические-примеры)
4. [**Модули для конфигурации**](#4-модули-для-конфигурации)
5. [**Паттерны организации модулей**](#5-паттерны-организации-модулей)
6. [**Динамический импорт**](#6-динамический-импорт)
7. [**Рекомендации по организации модулей**](#7-рекомендации-по-организации-модулей)
