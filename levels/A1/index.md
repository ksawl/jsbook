...
### [2.4. **Условия**](./2.4-conditions.md)

- Условные операторы `if`, `else`, `else if`, `switch`
- Тернарный оператор

### [2.5. **Проекты для закрепления**](./2.5-projects.md)
...
### [3.3. **Проекты для закрепления**](./3.3-projects.md)
...
### [4.3. **Проекты для закрепления**](./4.3-projects.md)
...
### [6.4. **Проекты для закрепления**](./6.4-projects.md)
...
### [7.4. **Проекты для закрепления**](./7.4-projects.md)
