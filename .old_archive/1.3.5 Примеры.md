...
> [!NOTE]
> Релевантный контент (условия, switch, базовые циклы) успешно мигрирован в `levels/A1/2.4-conditions-cycles.md` и `levels/A1/3.2-massives.md`. Блок исключений оставлен для уровня B1.
