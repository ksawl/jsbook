...
> [!NOTE]
> Частично мигрировано: раздел `for...of` и `for...in` перенесён в `levels/A2/2.1-cycles.md`. Объект `Set` перенесён в `levels/A2/3.2-collections.md`. Методы перебора массивов ожидают миграции.
