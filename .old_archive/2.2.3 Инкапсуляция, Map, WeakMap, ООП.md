...
> [!NOTE]
> Частично мигрировано: коллекции `Map` и `WeakMap` перенесены в `levels/A2/3.2-collections.md`. Инкапсуляция, Символы, Динамические классы и Proxy ожидают миграции.
