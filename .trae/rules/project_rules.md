...
- Каждый уровень имеет свою директорию с индексным файлом (0 Index.md)
- Индексные файлы всегда имеют номер 0

### Система нумерации
- Следовать принятой системе нумерации файлов (`[номер].[подномер]. [Название темы].md`)
- Использовать иерархическую нумерацию (1, 1.1, 1.1.1)
- Номера должны соответствовать логической последовательности изучения

### Изображения
- Размещать изображения в директории `img`
...
- Соблюдать единый стиль форматирования во всех документах
...
- Для JavaScript-кода использовать формат:
  ...
  ```
  ```
- Альтернативно можно использовать сокращение:
  ```
  ```js
  // код
  ```
...
2. Навигационные ссылки в начале документа. Формат навигации: `> [Home](../readme.md) || [A1](./0%20Index.md)`
